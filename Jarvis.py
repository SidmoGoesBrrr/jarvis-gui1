...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("C:\\Users\\user123\\Downloads\\JARVIS GUI\\jarvis-gui1\\Images\7LP8.gif")
        self.ui.label.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("C:\\Users\\user123\\Downloads\\JARVIS GUI\\jarvis-gui1\\Images\\T8bahf.gif")
    ...
    def showTime(self):
        ...
        print(f"The time is{label_time}")
        label_date = current_date.toString(Qt.ISODate)
        print(f"The time is{label_date}")
