...
class Ui_JarvisGUI(object):
    def setupUi(self, JarvisGUI):
        ...
        self.label_3.setPixmap(QtGui.QPixmap("../../../Pictures/side.PNG"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(6, -18, 1511, 121))
        self.label_4.setText("")
        self.label_4.setPixmap(QtGui.QPixmap("../../../Pictures/bottom.PNG"))
        self.label_4.setScaledContents(True)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(0, 2, 81, 1001))
        self.label_5.setText("")
        self.label_5.setPixmap(QtGui.QPixmap("../../../Pictures/side.PNG"))
...
"font-size:20px;")
        ...
        self.label_7.setPixmap(QtGui.QPixmap("../../../Downloads/logo jarvis.gif"))
